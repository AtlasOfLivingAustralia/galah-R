...
## 1 urn:lsid:biodiv… TRUE    REPTILIA        https://biodive… class    3000 33626 36658 taxonIdMa…
...
## 2    96 TRUE    "Exclude all records with an assertion that the scientific … "-ass…            1
## 3    97 TRUE    "Exclude all records with an assertion that the scientific … "-ass…            2
## 4    98 TRUE    "Exclude all records with an assertion that the name and cl… "-ass…            3
## 5    99 TRUE    "Exclude all records with an assertion that kingdom provide… "-ass…            4
## 6   100 TRUE    "Exclude all records with an assertion that the scientific … "-ass…            5
```
