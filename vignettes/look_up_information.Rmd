...
## 1 reptilia    REPTILIA        urn:lsid:biodiversity.org.au:afd.taxon:682e1228-5b3c-45ff-833b-… class exactMatch Animalia Chordata Reptil… noIss…
```
...
## 1 reptilia    REPTILIA        urn:lsid:biodiversity.org.au:afd.taxon:682e… class        exactMatch Animalia Chord… Repti… noIss… <NA>           
## 2 aves        AVES            urn:lsid:biodiversity.org.au:afd.taxon:5ed8… class        exactMatch Animalia Chord… Aves   noIss… Birds          
## 3 mammalia    MAMMALIA        urn:lsid:biodiversity.org.au:afd.taxon:e9e7… class        exactMatch Animalia Chord… Mamma… noIss… Mammals        
## 4 pisces      PISCES          urn:lsid:biodiversity.org.au:afd.taxon:e22e… species inq… exactMatch Animalia Chord… <NA>   noIss… fishes
```
...
## 1 REPTILIA        urn:lsid:biodiversity.org.au:afd.taxon:682e1228-5b3c-45ff-833b-550efd40c399 class taxonIdMatch Animalia Chordata Repti… noIss…
```
...
## 2 "Exclude all records with an assertion that the scientific name provided does not match any of the names lists … "-assertions:TAXON_MATCH_NON…
## 3 "Exclude all records with an assertion that the scientific name provided is not structured as a valid scientifi… "-assertions:INVALID_SCIENTI…
## 4 "Exclude all records with an assertion that the name and classification supplied can't be used to choose betwee… "-assertions:TAXON_HOMONYM"  
## 5 "Exclude all records with an assertion that kingdom provided doesn't match a known kingdom e.g. Animalia, Plant… "-assertions:UNKNOWN_KINGDOM"
## 6 "Exclude all records with an assertion that the scientific name provided in the record does not match the expec… "-assertions:TAXON_SCOPE_MIS…
```
