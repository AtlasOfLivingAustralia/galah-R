...
Starting with version 1.4.0, there have been three major improvements to how 
`galah` works:
...
- download functions used the prefix `ala`, but could actually query many living atlases (not just ALA)
