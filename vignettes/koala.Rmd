...
cols <- select_columns("country", group = "basic")
filters <- select_filters(year = seq(2000, 2020))
occ <- ala_occurrences(taxa = top5_banksia,
...
find_fields()
# View values for a given field
find_categories('basisOfRecord')
```
