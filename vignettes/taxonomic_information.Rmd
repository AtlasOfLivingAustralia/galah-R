...
```
##   search_term scientific_name                                                            taxon_concept_id   rank match_type  kingdom   phylum vernacular_name
## 1    Chordata        CHORDATA urn:lsid:biodiversity.org.au:afd.taxon:065f1da4-53cd-40b8-a396-80fa5c74dedd phylum exactMatch Animalia Chordata     vertebrates
##    issues
## 1 noIssue
```
...
## 1 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus         Heleioporus eyrei          (Gray, 1845)
## 2 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus  Heleioporus australiacus (Shaw & Nodder, 1795)
## 3 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus Heleioporus albopunctatus            Gray, 1841
## 4 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus  Heleioporus psammophilus    (Lee & Main, 1954)
## 5 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus     Heleioporus inornatus    (Lee & Main, 1954)
## 6 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus    Heleioporus barycragus             Lee, 1967
##                                                                  species_guid      vernacular_name
## 1 urn:lsid:biodiversity.org.au:afd.taxon:cf991494-ccee-433d-b049-f2a0996a0a3b         Moaning Frog
## 2 urn:lsid:biodiversity.org.au:afd.taxon:20119b25-a27c-4174-b3e0-8639e8a21131 Giant Burrowing Frog
## 3 urn:lsid:biodiversity.org.au:afd.taxon:c1d18a1e-5aec-4441-aa3c-e0ac799f51e8 Western Spotted Frog
## 4 urn:lsid:biodiversity.org.au:afd.taxon:0efbf288-1526-4551-af83-52e4fb9dae59            Sand Frog
## 5 urn:lsid:biodiversity.org.au:afd.taxon:16fcc761-685a-4527-b5e4-e6c7042ae2c6          Plains Frog
## 6 urn:lsid:biodiversity.org.au:afd.taxon:c527388c-1cc7-4a10-800a-243b5a2dcd3c   Western Marsh Frog
```
...
```
##    kingdom   phylum    class order          family       genus                  species                author
## 1 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus Heleioporus australiacus (Shaw & Nodder, 1795)
## 2 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus    Heleioporus inornatus    (Lee & Main, 1954)
## 3 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus        Heleioporus eyrei          (Gray, 1845)
## 4 Animalia Chordata Amphibia Anura Limnodynastidae Heleioporus   Heleioporus barycragus             Lee, 1967
##                                                                  species_guid      vernacular_name
## 1 urn:lsid:biodiversity.org.au:afd.taxon:20119b25-a27c-4174-b3e0-8639e8a21131 Giant Burrowing Frog
## 2 urn:lsid:biodiversity.org.au:afd.taxon:16fcc761-685a-4527-b5e4-e6c7042ae2c6          Plains Frog
## 3 urn:lsid:biodiversity.org.au:afd.taxon:cf991494-ccee-433d-b049-f2a0996a0a3b         Moaning Frog
## 4 urn:lsid:biodiversity.org.au:afd.taxon:c527388c-1cc7-4a10-800a-243b5a2dcd3c   Western Marsh Frog
```
...
## 1      Insecta 3118759
## 2   Gastropoda  824216
## 3 Malacostraca  507805
## 4    Arachnida  493395
## 5  Maxillopoda  462357
## 6   Polychaeta  256522
```
...
investigation. In that case you can return taxonomic information as a `data.tree`
using `ala_taxonomy()`. This function requires two arguments:
...
```r
# subet to nodes supplied by the Australian Faunal Directory only
...
This is because `classes` is an `S6` object. In fact, `data.tree`s have a few
unusual properties that we can exploit to do interesting things. A common task 
for example, is to calculate the number of records present for each node in the 
tree. A quick way to do this would be to extract all the `guid` values and query
them using `ala_counts()`.
...
## 5   ¦   ¦--Ascidiacea                 24267
## 6   ¦   °--Thaliacea                   9458
## 7   °--Vertebrata                  68779619
## 8       °--Gnathostomata           68779619
## 9           ¦--Amphibia              814058
## 10          ¦--Aves                59712649
## 11          ¦--Mammalia             3195438
## 12          ¦--Pisces               3761172
...
Although the `data.tree` format is useful, converting to a `data.frame` 
is straightforward.
...
there are multiple informal or unclassified nodes in the `data.tree`. Therefore,
a more useful approach is to take more care in linking levels and ranks, then 
...
If we want to take more information out of the `data.tree`, we can extract it 
...
There are a range of methods for visualising a `data.tree`. The `tidygraph` 
package can be used to convert a `data.tree` into a format suitable for plotting
with `ggraph`.
...
![plot of chunk ggraph](vignettes/taxonomic_information-ggraph-1.png)
