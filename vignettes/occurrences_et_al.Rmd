...
## 1 Animalia Chordata Mammalia Rodentia Muridae Mesembriomys Mesembriom… (J.E. G… urn:lsid:biodiversity.… Black-footed Tr…
## 2 Animalia Chordata Mammalia Rodentia Muridae Zyzomys      Zyzomys ar… (Thomas… urn:lsid:biodiversity.… Common Rock-rat 
## 3 Animalia Chordata Mammalia Rodentia Muridae Pseudomys    Pseudomys … (Waite,… urn:lsid:biodiversity.… Sandy Inland Mo…
## 4 Animalia Chordata Mammalia Rodentia Muridae Notomys      Notomys al… Thomas,… urn:lsid:biodiversity.… Spinifex Hoppin…
## 5 Animalia Chordata Mammalia Rodentia Muridae Melomys      Melomys bu… (Ramsay… urn:lsid:biodiversity.… Grassland Melom…
## 6 Animalia Chordata Mammalia Rodentia Muridae Mus          Mus muscul… Linnaeu… urn:lsid:biodiversity.… House Mouse
```
...
```
## Error in str(burrowing_frogs, give.attr = FALSE): object 'burrowing_frogs' not found
```
