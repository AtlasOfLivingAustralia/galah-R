...
##  4 A new Mexican species of Chrysina Kirby (Coleoptera: Scarabaeidae: Rutelinae), with nomenclatural changes, new records, and… http… dr554
...
##  9 A systematic revision of the genus Archocentrus (Perciformes: Cichlidae), with the description of two new genera and six ne… http… dr362
## 10 A taxonomic monograph of the genus Tylodinus Champion (Coleoptera: Curculionidae: Cryptorhynchinae: Tylodina) of Chiapas, M… http… dr564
## # … with 90 more rows
```
...
##  6 assertions_unchecked Assertion indicating a data quality test was not performed for this record typically due to the absenc… fiel… <NA> 
...
## 10 collection_code      The collection code for this record. This will be populated if the data has come from a museum or herb… fiel… <NA> 
## # … with 119 more rows
```
...
## 3 date_precision  The precision of the date information for the record. Values include 'Day', 'Month', 'Year', 'Year range', '… fiel… <NA>
```
...
## 1 vulpes      NBNSYS0000138878 Vulpes          Frisch, 1775               genus Animalia Tetrapoda  Carn… Mamm… Vulp… Chord… Canid… <NA>
```
...
##    scientificName                                         year
##    <chr>                                                 <dbl>
##  1 Sylvilagus brasiliensis subsp. truei (J. Allen, 1890)  1934
##  2 Sylvilagus floridanus (J. A. Allen, 1890)              1971
##  3 Sylvilagus floridanus (J. A. Allen, 1890)              1957
##  4 Sylvilagus brasiliensis subsp. gabbi (J. Allen, 1877)  1948
##  5 Sylvilagus floridanus (J. A. Allen, 1890)              1957
##  6 Sylvilagus floridanus (J. A. Allen, 1890)              1971
##  7 Sylvilagus brasiliensis subsp. truei (J. Allen, 1890)  1872
##  8 Sylvilagus brasiliensis subsp. truei (J. Allen, 1890)  1934
##  9 Sylvilagus brasiliensis subsp. truei (J. Allen, 1890)  1934
## 10 Sylvilagus floridanus (J. A. Allen, 1890)              1957
## # … with 29 more rows
```
...
<!--html_preserve--><div id="pweuwmjtrg" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#pweuwmjtrg .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#pweuwmjtrg .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#pweuwmjtrg .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#pweuwmjtrg .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#pweuwmjtrg .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#pweuwmjtrg .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#pweuwmjtrg .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#pweuwmjtrg .gt_from_md > :first-child {
  margin-top: 0;
}

#pweuwmjtrg .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#pweuwmjtrg .gt_row_group_first td {
  border-top-width: 2px;
}

#pweuwmjtrg .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#pweuwmjtrg .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#pweuwmjtrg .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#pweuwmjtrg .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pweuwmjtrg .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#pweuwmjtrg .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#pweuwmjtrg .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#pweuwmjtrg .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#pweuwmjtrg .gt_font_normal {
  font-weight: normal;
}

#pweuwmjtrg .gt_font_bold {
  font-weight: bold;
}

#pweuwmjtrg .gt_font_italic {
  font-style: italic;
}
...
#pweuwmjtrg .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#pweuwmjtrg .gt_indent_1 {
  text-indent: 5px;
}

#pweuwmjtrg .gt_indent_2 {
  text-indent: 10px;
}

#pweuwmjtrg .gt_indent_3 {
  text-indent: 15px;
}

#pweuwmjtrg .gt_indent_4 {
  text-indent: 20px;
}

#pweuwmjtrg .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
<td class="gt_row gt_right">7,129,917.00</td></tr>
