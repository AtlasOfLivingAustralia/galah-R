...
##    scientificName                                         year
##    <chr>                                                 <dbl>
##  1 Sylvilagus floridanus (J. A. Allen, 1890)              1971
##  2 Sylvilagus floridanus subsp. aztecus (J. Allen, 1890)  1947
##  3 Sylvilagus floridanus subsp. aztecus (J. Allen, 1890)  1924
##  4 Sylvilagus brasiliensis subsp. gabbi (J. Allen, 1877)  1948
##  5 Sylvilagus floridanus (J. A. Allen, 1890)              1971
##  6 Sylvilagus floridanus subsp. aztecus (J. Allen, 1890)  1924
##  7 Sylvilagus floridanus (J. A. Allen, 1890)              1960
##  8 Sylvilagus floridanus (J. A. Allen, 1890)              1963
##  9 Sylvilagus brasiliensis subsp. truei (J. Allen, 1890)  1934
## 10 Sylvilagus floridanus (J. A. Allen, 1890)              1906
## # … with 29 more rows
```
...
<!--html_preserve--><div id="peqjlajhec" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#peqjlajhec .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#peqjlajhec .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#peqjlajhec .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#peqjlajhec .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#peqjlajhec .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#peqjlajhec .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#peqjlajhec .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#peqjlajhec .gt_from_md > :first-child {
  margin-top: 0;
}

#peqjlajhec .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#peqjlajhec .gt_row_group_first td {
  border-top-width: 2px;
}

#peqjlajhec .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#peqjlajhec .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#peqjlajhec .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#peqjlajhec .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#peqjlajhec .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#peqjlajhec .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#peqjlajhec .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#peqjlajhec .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#peqjlajhec .gt_font_normal {
  font-weight: normal;
}

#peqjlajhec .gt_font_bold {
  font-weight: bold;
}

#peqjlajhec .gt_font_italic {
  font-style: italic;
}
...
#peqjlajhec .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#peqjlajhec .gt_indent_1 {
  text-indent: 5px;
}

#peqjlajhec .gt_indent_2 {
  text-indent: 10px;
}

#peqjlajhec .gt_indent_3 {
  text-indent: 15px;
}

#peqjlajhec .gt_indent_4 {
  text-indent: 20px;
}

#peqjlajhec .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
<td class="gt_row gt_right">1,804,083,934.00</td></tr>
    <tr><td class="gt_row gt_left">United Kingdom</td>
<td class="gt_row gt_right">207,796,355.00</td></tr>
...
<td class="gt_row gt_right">7,130,675.00</td></tr>
