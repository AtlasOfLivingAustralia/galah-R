...
##    scientificName                                         year
##    <chr>                                                 <dbl>
##  1 Sylvilagus floridanus (J. A. Allen, 1890)              1906
##  2 Sylvilagus floridanus (J. A. Allen, 1890)              1971
##  3 Sylvilagus floridanus subsp. aztecus (J. Allen, 1890)  1924
##  4 Sylvilagus floridanus (J. A. Allen, 1890)              1906
##  5 Sylvilagus floridanus subsp. aztecus (J. Allen, 1890)  1924
##  6 Sylvilagus brasiliensis subsp. gabbi (J. Allen, 1877)  1948
##  7 Sylvilagus floridanus (J. A. Allen, 1890)              1971
##  8 Sylvilagus Gray, 1867                                  1977
##  9 Sylvilagus Gray, 1867                                  1980
## 10 Sylvilagus floridanus subsp. aztecus (J. Allen, 1890)  1951
## # … with 29 more rows
```
...
<!--html_preserve--><div id="jaanssvjku" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#jaanssvjku .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#jaanssvjku .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#jaanssvjku .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#jaanssvjku .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#jaanssvjku .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#jaanssvjku .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#jaanssvjku .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#jaanssvjku .gt_from_md > :first-child {
  margin-top: 0;
}

#jaanssvjku .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#jaanssvjku .gt_row_group_first td {
  border-top-width: 2px;
}

#jaanssvjku .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#jaanssvjku .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#jaanssvjku .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#jaanssvjku .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#jaanssvjku .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#jaanssvjku .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#jaanssvjku .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#jaanssvjku .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#jaanssvjku .gt_font_normal {
  font-weight: normal;
}

#jaanssvjku .gt_font_bold {
  font-weight: bold;
}

#jaanssvjku .gt_font_italic {
  font-style: italic;
}
...
#jaanssvjku .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#jaanssvjku .gt_indent_1 {
  text-indent: 5px;
}

#jaanssvjku .gt_indent_2 {
  text-indent: 10px;
}

#jaanssvjku .gt_indent_3 {
  text-indent: 15px;
}

#jaanssvjku .gt_indent_4 {
  text-indent: 20px;
}

#jaanssvjku .gt_indent_5 {
  text-indent: 25px;
}
</style>
...
<td class="gt_row gt_right">1,804,086,788.00</td></tr>
    <tr><td class="gt_row gt_left">United Kingdom</td>
<td class="gt_row gt_right">207,796,356.00</td></tr>
...
<td class="gt_row gt_right">7,131,872.00</td></tr>
