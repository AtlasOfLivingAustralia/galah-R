...
## Supported Atlases
To show the Atlases currently supported by `galah`, use `show_all_atlases()`. This
...
```
## Warning: `ala_counts()` was deprecated in galah 1.4.0.
