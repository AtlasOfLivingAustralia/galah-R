...
```
## # A tibble: 1 × 13
##   search_term   scientific_name scientific…¹ taxon…² rank  match…³ kingdom phylum class order family genus issues
##   <chr>         <chr>           <chr>        <chr>   <chr> <chr>   <chr>   <chr>  <chr> <chr> <chr>  <chr> <chr> 
## 1 Eolophus_Aves Eolophus        Bonaparte, … https:… genus exactM… Animal… Chord… Aves  Psit… Cacat… Eolo… noIss…
...
galah_call() |> 
  galah_identify(c("Vulpes vulpes", "Meles meles")) |> 
  galah_group_by(species) |> 
  atlas_counts()
```
...
## ✖ Invalid field(s): galah_identify(galah_call(), c("Vulpes vulpes", "Meles meles")).
```
