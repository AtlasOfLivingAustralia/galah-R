...
## 1 Reptilia    REPTILIA        https://biodiversity… class exactMatch Animal… Chord… Rept… noIss…
```
...
## 1 Eolophus_Aves Eolophus        Bonaparte, 1854        https://biodive… genus exactMatch Animal…
## # ℹ abbreviated name: ¹​scientific_name_authorship
## # ℹ 6 more variables: phylum <chr>, class <chr>, order <chr>, family <chr>, genus <chr>,
## #   issues <chr>
```
...
##    <chr>          <int>
##  1 Insecta      6594341
##  2 Gastropoda   1076805
##  3 Arachnida     875343
##  4 Maxillopoda   701445
##  5 Malacostraca  666484
##  6 Polychaeta    278910
##  7 Bivalvia      238463
##  8 Anthozoa      228511
##  9 Cephalopoda   150026
## 10 Demospongiae  119165
## # ℹ 60 more rows
```
...
##    <chr> <chr>                 <int>
##  1 2020  HUMAN_OBSERVATION   6858790
##  2 2020  OCCURRENCE           188090
##  3 2020  PRESERVED_SPECIMEN    87525
##  4 2020  MACHINE_OBSERVATION   39642
##  5 2020  OBSERVATION            4417
##  6 2020  MATERIAL_SAMPLE        2058
##  7 2020  LIVING_SPECIMEN          62
##  8 2019  HUMAN_OBSERVATION   6103737
##  9 2019  PRESERVED_SPECIMEN   166170
...
```
## # A tibble: 6 × 6
##   acceptedNameUsage acceptedNameUsageID basisOfRecord   raw_basisOfRecord OCCURRENCE_STATUS_IN…¹
##   <chr>             <lgl>               <chr>           <chr>             <lgl>                 
## 1 <NA>              NA                  HUMAN_OBSERVAT… HumanObservation  FALSE                 
## 2 <NA>              NA                  PRESERVED_SPEC… PreservedSpecimen FALSE                 
## 3 <NA>              NA                  PRESERVED_SPEC… PreservedSpecimen FALSE                 
## 4 <NA>              NA                  HUMAN_OBSERVAT… HumanObservation  FALSE                 
## 5 <NA>              NA                  PRESERVED_SPEC… PreservedSpecimen FALSE                 
## 6 <NA>              NA                  HUMAN_OBSERVAT… HumanObservation  FALSE                 
## # ℹ abbreviated name: ¹​OCCURRENCE_STATUS_INFERRED_FROM_BASIS_OF_RECORD
## # ℹ 1 more variable: userDuplicateRecord <lgl>
```
...
## 1 https://biodiversit… Perameles e… Spencer, 1897          species    Animal… Chord… Mamm… Pera…
## # ℹ abbreviated name: ¹​scientific_name_authorship
