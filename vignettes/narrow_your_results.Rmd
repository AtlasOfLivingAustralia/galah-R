...
```
## Error in `FUN()`:
## ! The `names_search_multiple` API is not available for the selected atlas (United Kingdom)
...
```
## Error in get_gbifid("Lepus", messages = FALSE, rows = 1): could not find function "get_gbifid"
```
...
```
## Error in get_nbnid(c("Vulpes vulpes", "Meles meles"), messages = FALSE, : could not find function "get_nbnid"
```
...
##  1 Insecta      3930664
##  2 Gastropoda    876882
##  3 Malacostraca  573510
##  4 Arachnida     551093
##  5 Maxillopoda   473345
##  6 Polychaeta    258880
##  7 Bivalvia      215223
##  8 Anthozoa      169036
##  9 Demospongiae  113262
## 10 Ostracoda      58698
## # … with 73 more rows
```
...
##    <chr>             <chr>   <int>
##  1 HUMAN_OBSERVATION 2020  6292943
##  2 HUMAN_OBSERVATION 2019  5517222
##  3 HUMAN_OBSERVATION 2018  5237592
##  4 HUMAN_OBSERVATION 2017  4347152
##  5 HUMAN_OBSERVATION 2016  3512405
...
## 1 Animalia Chordata Mammalia Peramelemorphia Peramelidae Perameles Perameles eremiana     Spence… https:… Desert…
## 2 Animalia Chordata Mammalia Peramelemorphia Peramelidae Perameles Perameles bougainville Quoy &… https:… Shark …
