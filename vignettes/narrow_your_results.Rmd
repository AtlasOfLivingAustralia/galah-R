...
##   <chr>       <chr>           <chr>                  <chr>            <chr>
## 1 Eolophus_A… Eolophus        Bonaparte, 1854        https://biodive… genus
...
##   <chr>             <lgl>               <chr>             <chr>            
## 1 <NA>              NA                  PRESERVED_SPECIM… PreservedSpecimen
## 2 <NA>              NA                  PRESERVED_SPECIM… PreservedSpecimen
## 3 <NA>              NA                  PRESERVED_SPECIM… PreservedSpecimen
## 4 <NA>              NA                  HUMAN_OBSERVATION HumanObservation 
## 5 <NA>              NA                  PRESERVED_SPECIM… PreservedSpecimen
## 6 <NA>              NA                  HUMAN_OBSERVATION HumanObservation 
## # ℹ 2 more variables:
## #   OCCURRENCE_STATUS_INFERRED_FROM_BASIS_OF_RECORD <lgl>,
...
##   <chr>              <chr>        <chr>                  <chr>      <chr>  
## 1 https://biodivers… Perameles e… Spencer, 1897          species    Animal…
## # ℹ abbreviated name: ¹​scientific_name_authorship
