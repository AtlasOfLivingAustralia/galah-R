...
followed by a suffix describing the information that they provide. For example,
we anticipate that users will wish to download occurrence data, which can be
achieved using the function `ala_occurrences()`. 
