...
## 1:  Aves Psittaciformes Cacatuidae Eolophus noIssue                  <NA>            <NA> 852049
## 2:  Aves Psittaciformes Cacatuidae Eolophus noIssue Eolophus roseicapilla           Galah 852047
```
...
```
## Error in `$<-.data.frame`(`*tmp*`, "logical", value = c("=", ">=", NA)): replacement has 3 rows, data has 2
```
...
```
## Error in validate_filters(df$variable): The following filters are invalid: profile. Use `search_fields()` to get a list of valid options
```
...
```
## Error in `$<-.data.frame`(`*tmp*`, "logical", value = c("=", NA)): replacement has 2 rows, data has 1
```
...
## 1       -43.03333         147.3000 2000-12-11T13:00:00Z Microseris lanceolata
## 2       -41.88333         147.7667 2000-01-16T13:00:00Z Microseris lanceolata
## 3       -37.64790         144.9673 2000-06-13T14:00:00Z Microseris lanceolata
## 4       -36.45776         149.3639 2000-01-07T13:00:00Z Microseris lanceolata
## 5       -36.41611         148.4047 2000-03-10T13:00:00Z Microseris lanceolata
## 6       -36.41444         148.4008 2000-03-10T13:00:00Z Microseris lanceolata
##                                       taxonConceptID                             recordID             dataResourceName
## 1 https://id.biodiversity.org.au/taxon/apni/51268659 e00a8e52-bff8-4129-8038-fbf5ccb75fdd                  HO AVH data
## 2 https://id.biodiversity.org.au/taxon/apni/51268659 3033f96b-3c12-41ff-ae04-d1002898a431                  HO AVH data
## 3 https://id.biodiversity.org.au/taxon/apni/51268659 d1e5b63f-781b-4476-8b7b-1aeb380e0a9b Victorian Biodiversity Atlas
## 4 https://id.biodiversity.org.au/taxon/apni/51268659 ce6cb3bf-0d54-4734-8a0a-ad8e63c7aeb4             NSW BioNet Atlas
## 5 https://id.biodiversity.org.au/taxon/apni/51268659 39916933-0f45-441f-8630-d879c2d329b9 Victorian Biodiversity Atlas
## 6 https://id.biodiversity.org.au/taxon/apni/51268659 ecd835c5-f6c4-4164-baf6-725b24874228 Victorian Biodiversity Atlas
```
