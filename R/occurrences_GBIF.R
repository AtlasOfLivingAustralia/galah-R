#' internal workhorse function for GBIF occurrences
#' @noRd
#' @keywords Internal
...
occurrences_GBIF <- function(identify = NULL,
  ...
  # Check record count
  if (pour("package", "run_checks") && format == "SIMPLE_CSV") {
