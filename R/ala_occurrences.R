...
#' @param columns \code{data.frame}: DEPRECATED - use \code{select} instead
...
#' occ <- ala_occurrences(filter = galah_filter(year = seq(2010, 2020)))
#'
...
#' occ <- ala_occurrences(location = galah_location(polygon))
#' }
#' 
#' @export
