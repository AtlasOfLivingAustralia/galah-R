...
#'     those functions (see [superseded_functions]).
...
#' [galah_call()].
#' @param identify `r lifecycle::badge("superseded")` `tibble`: generated by a call to [galah_identify()].
#' @param filter `r lifecycle::badge("superseded")` `tibble`: generated by a call to [galah_filter()]
#' @param geolocate `r lifecycle::badge("superseded")` `string`: generated by a call to [galah_geolocate()]
#' @param apply_profile `r lifecycle::badge("superseded")` `string`: generated by a call to [galah_apply_profile()]
#' @param select `r lifecycle::badge("superseded")` `tibble`: generated by a call to [galah_select()] 
