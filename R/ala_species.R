...
#'
#' @param request \code{data_request} object generated by data_request()
#' @inheritParams data_request
#' @param ... Arguments to be passed to \code{ala_species}
...
#' @export
#' @rdname ala_species
ala_species.default <- function(taxa = NULL, filters = NULL, locations = NULL, refresh_cache = FALSE, ...) {
