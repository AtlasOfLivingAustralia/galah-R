...
#'
#' `ala_counts` takes filters in the same format as\code{\link{ala_occurrences}}.
#' Provides either a total count of records matching the criteria, or a
#' data.frame of counts matching the criteria, broken down by the `group_by` field.
#'
#' @param taxa string or data.frame: one or more unique species identifiers.
#' Use \code{\link{ala_taxa}} to generate a data.frame for this argument.
...
#' @return either single integer of total counts, or a data.frame of counts by
