...
- They have the ability to accept `filter`, `select` etc as arguments,
  ...
  [superseded_functions](https://galah.ala.org.au/R/reference/superseded_functions.md)).
...
- identify:
  ...
  **\[superseded\]** `tibble`: generated by a call to
...
- geolocate:
  ...
  **\[superseded\]** `string`: generated by a call to
