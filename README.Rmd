...
`galah` is an R package for accessing data from the [Atlas of Living Australia (ALA)](https://ala.org.au) APIs. It is the successor to [`ALA4R`](https://github.com/AtlasOfLivingAustralia/ALA4R)
