...
Australia](https://www.ala.org.au/) (ALA). It enables users to locate an
download species observations, taxonomic information, or associated media such
...
their results to observations that meet particular quality-control criteria. All functions return a `data.frame` as their standard format.
