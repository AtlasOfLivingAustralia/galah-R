...
<img src="man/figures/galah_logo.png" align="left" style="margin: 0px 10px 0px 0px;" alt="" width="120"/><h1 style="font-size:40px"><strong>galah</strong></h1>
...
Australia](https://www.ala.org.au/) (ALA).<br><br>
  
It enables users to locate and download species observations, taxonomic information, or associated media such
