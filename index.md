...
- For an outline of the package structure, and a list of all the
  ...
  [`?galah`](https://galah.ala.org.au/R/reference/galah.md) or view the
  [reference page](https://galah.ala.org.au/R/reference/index.html).
...
[![](reference/figures/galah_cheatsheet_thumbnail.png)](https://github.com/AtlasOfLivingAustralia/galah-R/blob/main/cheatsheet/galah-r.pdf)
...
To generate a citation for the downloaded occurrence records, pass the
`tibble` generated to
